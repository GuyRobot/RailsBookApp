...
class BooksController < ApplicationController
  ...
  # Add and remove books to/from library for current user
  def library
    type = params[:type]
    ...
    if type == 'add'
      ...
      redirect_to root_path, notice: "#{@book.title} was remove from your library"
    else
      # Nothing
      redirect_to book_path(@book), notice: 'Nothing happen'
    end
  end
